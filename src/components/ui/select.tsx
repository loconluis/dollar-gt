...
/**
 * Radix Select: real listbox semantics, keyboard navigation, typeahead
 * and focus management. Replaces the previous hand-rolled button+div
 * dropdown, which had none of those.
 */
    ...
    >
      ...
      <SelectPrimitive.Viewport
        className={cn(
          "p-1",
          position === "popper" &&
            "h-[var(--radix-select-trigger-width)] min-h-[var(--radix-select-trigger-height)] w-full min-w-[var(--radix-select-trigger-width)]",
        )}
      >
        {children}
      </SelectPrimitive.Viewport>
